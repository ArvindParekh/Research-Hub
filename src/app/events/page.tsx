...
export default function EventsPage() {
  ...
  const eventTypes = ["All Types", "Conference", "Workshop", "Symposium", "Seminar", "Webinar"]
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8">
        {/* Page Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2">Academic Events & Conferences</h1>
          <p className="text-muted-foreground">
            Discover, attend, and host virtual and hybrid academic events with interactive features
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-4 mb-8">
          <div className="relative md:col-span-2">
            ...
            <Input placeholder="Search events by title, topic, or organizer..." className="pl-10" />
          </div>
          <Select>
            <SelectTrigger>
          ...
          <Select>
            ...
            <SelectContent>
              {formats.map((format) => (
                <SelectItem key={format} value={format.toLowerCase().replace(" ", "-")}>
                  {format}
                </SelectItem>
              ))}
            </SelectContent>
                          ...
                          <div className="flex items-start justify-between">
                            <div className="flex-1">
                              <div className="flex items-center gap-3 mb-2">
                                ...
                                {event.isFeatured && <Badge className="bg-yellow-100 text-yellow-800">Featured</Badge>}
                              </div>

                              <p className="text-muted-foreground font-medium mb-2">{event.subtitle}</p>
          ...
          <TabsContent value="live" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Events currently happening now</CardDescription>
              </CardHeader>
              <CardContent>
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                              {event.attendees.toLocaleString()} attendees • {event.format}
                            </p>
                          </div>
                        </div>
                        <Button size="sm" className="bg-red-600 hover:bg-red-700">
                  ...
                  {upcomingEvents.map((event) => (
                    <div key={event.id} className="flex items-center justify-between p-4 border rounded-lg">
                      <div>
                        <h4 className="font-medium">{event.title}</h4>
                        <p className="text-sm text-muted-foreground">
                          {event.date} • {event.type} • {event.attendees.toLocaleString()} registered
                        </p>
                      </div>
                      <Button variant="outline" size="sm">
                        Register
