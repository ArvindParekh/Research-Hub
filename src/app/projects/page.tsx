...
import { BookOpen, Plus, Calendar, Users, CheckCircle, Clock, AlertCircle, Search } from "lucide-react"
  ...
  const projects = [
    {
      ...
      description: "Developing automated methods for discovering optimal neural network architectures",
      status: "active",
      progress: 75,
      dueDate: "2024-03-15",
      team: [
    ...
    },
    {
      ...
      description: "Building efficient simulators for quantum computing algorithms",
      status: "active",
      progress: 45,
      dueDate: "2024-04-20",
      team: [
    ...
    },
    {
      ...
      description: "Developing AI methods for analyzing complex brain imaging data",
      status: "planning",
      progress: 15,
      dueDate: "2024-06-30",
      team: [
        ...
        <Tabs defaultValue="projects" className="space-y-6">
          ...
          <TabsContent value="calendar">
            <div className="border border-border rounded-lg p-6">
              <h3 className="font-semibold text-foreground mb-2">Project Calendar</h3>
              <p className="text-sm text-muted-foreground">Calendar view for project timelines and deadlines</p>
            </div>
          </TabsContent>
        </Tabs>
      </div>
