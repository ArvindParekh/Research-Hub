...
const getPaper = (id: string) => {
  const papers = {
    "neural-arch-2024": {
      ...
      version: "v2",
      versions: [
        { version: "v1", date: "2024-01-10", changes: "Initial submission" },
        { version: "v2", date: "2024-01-15", changes: "Added experimental results and improved methodology section" },
      ],
      downloads: 1247,
      views: 3891,
      citations: 23,
      ...
      rating: 4.6,
      status: "under-review",
      keywords: ["Neural Architecture Search", "Quantum Computing", "Optimization", "Deep Learning"],
      ...
      <div className="container mx-auto px-4 py-8">
                ...
                {paper.authors.map((author, index) => (
                  <div key={index} className="flex items-center gap-2">
                    <Avatar className="w-8 h-8">
                      <AvatarImage src={`/placeholder.svg?height=32&width=32&query=professional academic portrait`} />
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
            <Card>
              <CardContent className="p-4 text-center">
                <div className="text-2xl font-bold text-primary">{paper.views.toLocaleString()}</div>
                <div className="text-sm text-muted-foreground">Views</div>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-4 text-center">
                <div className="text-2xl font-bold text-primary">{paper.downloads.toLocaleString()}</div>
            ...
            <Card>
              <CardContent className="p-4 text-center">
                <div className="text-2xl font-bold text-primary">{paper.reviews}</div>
        ...
        <Tabs defaultValue="abstract" className="space-y-6">
          <TabsList className="grid w-full grid-cols-5">
            ...
            <TabsTrigger value="reviews">Reviews ({paper.reviews})</TabsTrigger>
          ...
          <TabsContent value="abstract" className="space-y-6">
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground leading-relaxed mb-6">{paper.abstract}</p>
          ...
          <TabsContent value="reviews" className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <span className="text-2xl font-bold">{paper.rating}</span>
                    ...
                    <div className="space-y-2">
                      {[5, 4, 3, 2, 1].map((stars) => (
                        <div key={stars} className="flex items-center gap-2">
                          ...
                          <Progress value={stars === 5 ? 60 : stars === 4 ? 40 : 0} className="flex-1" />
                          <span className="text-sm text-muted-foreground w-8">
                            {stars === 5 ? "5" : stars === 4 ? "3" : "0"}
                          </span>
                        </div>
                      ))}
                    </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{paper.reviews}</span>
                      </div>
                      <div className="flex justify-between">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Share your thoughts and help improve this research</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div>
                  ...
                  <div>
                    <label className="text-sm font-medium mb-2 block">Review Summary</label>
                    <input
                  ...
                  <div>
                    <label className="text-sm font-medium mb-2 block">Detailed Review</label>
          ...
          <TabsContent value="versions" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Track changes and improvements across paper versions</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
          ...
          <TabsContent value="citations" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Papers that have cited this work</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center py-8">
                  <FileText className="w-12 h-12 text-muted-foreground mx-auto mb-4" />
                  <p className="text-muted-foreground">
                    Citation tracking will be available once the paper is published.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center py-8">
                  ...
                  <p className="text-muted-foreground mb-4">Start a discussion about this paper.</p>
