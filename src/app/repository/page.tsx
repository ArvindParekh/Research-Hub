      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Open access preprint repository with community peer review and version control
          </p>
        </div>
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            <CardTitle className="text-xl">
                              <Link href={`/repository/${paper.id}`} className="hover:text-primary transition-colors">
                                {paper.title}
                              </Link>
                            </CardTitle>
                          ...
                          <CardDescription className="mb-4 line-clamp-2">{paper.abstract}</CardDescription>
                    ...
                    <CardContent>
                      <div className="flex items-center justify-between">
                        ...
                        <Button variant="ghost" size="sm" asChild>
                          <Link href={`/repository/${paper.id}`}>View Details</Link>
                        </Button>
                      </div>
                    </CardContent>
                  </Card>
          ...
          <TabsContent value="trending" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Papers gaining the most attention in the research community</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {featuredPapers.slice(0, 2).map((paper, index) => (
                    <div key={paper.id} className="flex items-center gap-4 p-4 border rounded-lg">
          ...
          <TabsContent value="recent" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Latest papers submitted to the repository</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {featuredPapers.map((paper) => (
          ...
          <TabsContent value="my-papers" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Papers you have authored or co-authored</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center py-8">
                  ...
                  <Button asChild>
                    <Link href="/repository/submit">Submit Your First Paper</Link>
                  </Button>
                </div>
              </CardContent>
            </Card>
