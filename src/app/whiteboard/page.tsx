      ...
      <header className="border-b bg-card p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="font-semibold">Neural Network Architecture Brainstorm</h2>
        ...
        <div className="w-16 border-r bg-card flex flex-col items-center py-4 gap-2">
          ...
          <div className="grid grid-cols-2 gap-1">
            {colors.map((color) => (
              <button
                key={color}
                className={`w-4 h-4 rounded border-2 ${selectedColor === color ? "border-foreground" : "border-muted"}`}
          ...
          <Button variant="ghost" size="sm" className="w-10 h-10 p-0" title="Clear">
        ...
        <div className="flex-1 relative bg-white">
          ...
          <div className="absolute inset-0 overflow-hidden">
            ...
            >
              ...
              <rect x="100" y="100" width="200" height="150" fill="none" stroke="#0066cc" strokeWidth="2" />
              <text x="120" y="130" fontSize="14" fill="#333">
                Input Layer
              </text>

              <rect x="350" y="80" width="200" height="190" fill="none" stroke="#cc6600" strokeWidth="2" />
              <text x="370" y="110" fontSize="14" fill="#333">
                Hidden Layers
              </text>

              <rect x="600" y="120" width="150" height="110" fill="none" stroke="#009900" strokeWidth="2" />
              <text x="620" y="150" fontSize="14" fill="#333">
                Output Layer
              </text>

              {/* Arrows */}
              <path d="M300 175 L350 175" stroke="#666" strokeWidth="2" markerEnd="url(#arrowhead)" />
              <path d="M550 175 L600 175" stroke="#666" strokeWidth="2" markerEnd="url(#arrowhead)" />
              ...
              {collaborators.map(
                (collaborator, index) =>
                  collaborator.cursor && (
                    <g key={index}>
                      <circle cx={`${collaborator.cursor.x}%`} cy={`${collaborator.cursor.y}%`} r="4" fill="#ff4444" />
                      <text
        ...
        <div className="w-64 border-l bg-card p-4">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input type="range" min="1" max="10" defaultValue="2" className="w-full" />
            </div>
