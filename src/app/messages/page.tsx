...
import { BookOpen, Phone, Video, Users, Plus, Search, Send } from "lucide-react"
...
export default function MessagesPage() {
  ...
  const currentMessages = [
    ...
    },
    {
      id: 2,
      sender: "You",
      content: "Congratulations Sarah! I'll take a look at it this afternoon. The abstract looks very promising.",
      time: "10:32 AM",
      isOwn: true,
    },
    {
        ...
        <ScrollArea className="flex-1">
          ...
          <div className="p-4">
            <div className="flex items-center justify-between mb-3">
              <h3 className="font-semibold text-xs text-muted-foreground uppercase tracking-wide">Research Groups</h3>
          ...
          <div className="p-4">
            <div className="flex items-center justify-between mb-3">
              <h3 className="font-semibold text-xs text-muted-foreground uppercase tracking-wide">Direct Messages</h3>
              <Button size="sm" variant="ghost">
                <Plus className="w-4 h-4" />
              </Button>
            </div>
        ...
        <div className="p-4 border-b border-border bg-card">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground">ML Research Lab • 12 members</p>
            </div>
            <div className="flex items-center gap-2">
                ...
                <div className={`flex-1 max-w-md ${message.isOwn ? "text-right" : ""}`}>
                  ...
                  <div
                    className={`p-3 rounded text-sm ${
                      message.isOwn ? "bg-primary text-primary-foreground ml-auto w-fit" : "bg-muted text-foreground"
                    }`}
                  >
                    {message.content}
                  </div>
