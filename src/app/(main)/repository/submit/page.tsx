         ...
         <div className='container mx-auto px-4 py-8 max-w-3xl'>
            <div className='mb-8'>
               ...
               <p className='text-muted-foreground'>
                  Share your research with the academic community. You can save
                  as draft and submit for review later.
               </p>
            </div>
            ...
            <div className='space-y-6'>
               ...
               <Card>
                  <CardHeader>
                     ...
                     <CardDescription>
                        Provide a summary of your research (typically 150-250
                        words)
                     </CardDescription>
                  </CardHeader>
                  <CardContent>
