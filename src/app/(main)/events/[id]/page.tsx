              ...
              <TabsContent value="posters" className="space-y-4">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Interactive poster presentations from researchers
                      worldwide
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    ...
                    <div className="space-y-4">
                      <div className="p-4 border rounded-lg">
                        ...
                        <p className="text-sm text-muted-foreground mb-3">
                          Join spontaneous video chats with other attendees in
                          our virtual lobby
                        </p>
                        <Button>
                      ...
                      <div className="p-4 border rounded-lg">
                        <h4 className="font-medium mb-2">Breakout Rooms</h4>
                        <p className="text-sm text-muted-foreground mb-3">
                          Join topic-specific discussions with small groups of
                          participants
                        </p>
                      ...
                      <div className="p-4 border rounded-lg">
                        <h4 className="font-medium mb-2">1-on-1 Meetings</h4>
                        <p className="text-sm text-muted-foreground mb-3">
                          Schedule private meetings with other attendees
                        </p>
                        <Button variant="outline">
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      },
                      {
                        name: "Prof. Bob Smith",
                        rating: 5,
                        comment: "Great networking opportunities and content",
                      },
                    ].map((review, index) => (
