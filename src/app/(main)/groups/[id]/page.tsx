...
import { MapPin, Users, ArrowLeft, Settings } from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-start justify-between mb-6">
            <div className="flex-1">
              <h1 className="text-4xl font-semibold mb-2">{group.name}</h1>
        ...
        <Tabs defaultValue="about" className="space-y-6">
          ...
          <TabsContent value="about" className="space-y-6">
            ...
            <div className="border border-border rounded-lg p-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-medium text-foreground">{group.leader}</p>
          ...
          <TabsContent value="announcements" className="space-y-4">
            {group.announcements.map((announcement: any, index: number) => (
              <div key={index} className="border border-border rounded-lg p-6">
