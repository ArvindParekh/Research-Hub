          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Your Sociolect profile will be automatically included with
                  your application
                </CardDescription>
              </CardHeader>
              <CardContent>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <label htmlFor="updates" className="text-sm">
                      I would like to receive updates about my application
                      status
                    </label>
                  </div>
              ...
              <CardContent>
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">Sociolect Profile</span>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-green-500 mt-0.5 shrink-0" />
                    <span>
                      Include specific examples in your teaching statement
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-green-500 mt-0.5 shrink-0" />
