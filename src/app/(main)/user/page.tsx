        ...
        <div className="mb-12">
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="flex-1">
              ...
              <p className="text-lg text-muted-foreground mb-1">{user.title}</p>
              ...
              <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground mb-6">
                ...
                <div className="flex items-center gap-1">
                  ...
                  {currentUser?.primaryEmail && currentUser.primaryEmail}
                </div>
                <div className="flex items-center gap-1">
                  ...
                  >
                    ...
                    <p className="text-xs text-muted-foreground">
                      ...
                      {publication.publicationDate
                        ? format(publication.publicationDate, "MMMM yyyy")
                        : "N/A"}{" "}
                      •{" "}
                      {publication._count.citations_received +
                        publication._count.paperCitationsReceived}{" "}
                      citations
                    </p>
