  ...
  const groups = [
    {
      ...
      description: "Collaborative research group focused on deep learning and neural architectures",
      members: 24,
      maxMembers: 50,
    ...
    },
    {
      ...
      description: "International group exploring quantum algorithms and quantum information theory",
      members: 18,
      maxMembers: 30,
    ...
    },
    {
      ...
      description: "Advancing brain imaging analysis and computational neuroscience",
      members: 32,
      maxMembers: 60,
      field: "Neuroscience",
      institution: "Harvard Medical School",
      leader: "Dr. Emily Johnson",
      topics: ["Brain Imaging", "Computational Neuroscience", "Neural Modeling"],
      isJoined: false,
    },
  ]
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Join collaborative research groups and connect with peers in your field
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-8">
          <div className="relative md:col-span-2">
            ...
            <Input placeholder="Search groups by name or field..." className="pl-10" />
          </div>
          <Select>
            <SelectTrigger>
        ...
        <div className="grid gap-6">
          {groups.map((group) => (
            <Card key={group.id} className="hover:border-primary/20 transition-colors">
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      {group.isJoined && <Badge variant="outline">Joined</Badge>}
                    </div>
              ...
              <CardContent>
                <div className="flex items-center justify-between">
                  ...
                  <Button asChild variant={group.isJoined ? "outline" : "default"}>
                    <Link href={`/groups/${group.id}`}>{group.isJoined ? "View Group" : "Join Group"}</Link>
                  </Button>
                </div>
              </CardContent>
            </Card>
