          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="p-6 border border-border rounded-lg hover:border-primary/20 transition-colors">
              ...
              <p className="text-sm text-muted-foreground">
                Customizable profiles with publication tracking and impact
                metrics
              </p>
            </div>
      ...
      <footer className="border-t border-border bg-card py-12 px-4">
        <div className="container mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="font-semibold text-foreground">Sociolect</span>
              </div>
              <p className="text-sm text-muted-foreground">
          ...
          <div className="border-t border-border pt-8 text-center text-sm text-muted-foreground">
            <p>&copy; 2025 Sociolect. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
