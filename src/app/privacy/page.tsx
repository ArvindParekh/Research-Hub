        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-sm text-muted-foreground space-y-6">
            <section>
              ...
              <p>
                Academic Nexus ("we," "us," "our," or "Company") is committed to protecting your privacy. This Privacy
            ...
            <section>
              ...
              <p>
                ...
                profile, upload research papers, or contact us for support.
              </p>
              <ul className="list-disc list-inside space-y-2 ml-4 mt-3">
                <li>Personal identification information (name, email, institution)</li>
                <li>Professional information (research field, publications, affiliations)</li>
            ...
            <section>
              ...
              <p>
                We use the information we collect to operate and improve our platform, provide personalized
                recommendations, facilitate collaboration, and communicate with you.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                You have the right to access, update, or delete your personal information at any time by logging into
            ...
            <section>
              ...
              <p>
                If you have any questions about this Privacy Policy, please contact us at privacy@academicnexus.com.
              </p>
            </section>
          </div>
        </div>
