...
const getJob = (id: string) => {
  const jobs = {
    "mit-ml-prof-2024": {
      ...
      applicationProcess: [
        "Submit application through Academic Nexus",
      ...
      tags: ["Machine Learning", "Deep Learning", "Faculty", "Tenure Track", "MIT"],
      applicants: 127,
      isUrgent: false,
      isFeatured: true,
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-4 mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-lg font-medium">{job.institution}</span>
                </div>
                <div className="flex items-center gap-2">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            ...
            <Card>
              <CardContent className="p-4 text-center">
                ...
                <div className="text-sm text-muted-foreground">Institution Rating</div>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-4 text-center">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="prose prose-sm max-w-none">
                  <div className="whitespace-pre-line text-muted-foreground">{job.fullDescription}</div>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Use your Academic Nexus profile to apply instantly</CardDescription>
              </CardHeader>
              <CardContent>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm">Cambridge, Massachusetts</span>
                  </div>
              ...
              <CardContent>
                <div className="space-y-2 text-sm">
                  ...
                  <p>
                    ...
                    <Link href={job.website} className="text-primary hover:underline">
                      {job.website}
                    </Link>
                  </p>
                </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  {[
                    { title: "Postdoc in ML", institution: "Stanford", type: "Postdoc" },
                    { title: "Research Scientist", institution: "Google", type: "Industry" },
                  ].map((similarJob, index) => (
                    <div key={index} className="p-3 border rounded-lg">
                      <h4 className="font-medium text-sm">{similarJob.title}</h4>
                      <p className="text-xs text-muted-foreground">{similarJob.institution}</p>
