...
export default function JobsPage() {
  const featuredJobs = [
    {
      ...
      benefits: ["Health insurance", "Retirement plan", "Research funding", "Sabbatical leave"],
    ...
    },
    {
      ...
      benefits: ["Health insurance", "Professional development funds", "Conference travel support"],
    ...
    },
    {
      ...
      benefits: ["Full tuition coverage", "Health insurance", "Research stipend", "Conference funding"],
    ...
    },
    {
      ...
      benefits: ["Competitive salary", "Stock options", "Health benefits", "Research freedom"],
  ...
  const jobTypes = ["All Types", "Faculty", "Postdoc", "PhD", "Industry", "Research Staff"]
  const locations = ["All Locations", "United States", "Europe", "Asia", "Remote"]
  const fields = ["All Fields", "Computer Science", "Physics", "Biology", "Chemistry", "Mathematics", "Engineering"]
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Discover opportunities in academia and research. Apply with your Academic Nexus profile.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-4 mb-8">
          <div className="relative md:col-span-2">
            ...
            <Input placeholder="Search jobs by title, institution, or keywords..." className="pl-10" />
          </div>
          <Select>
            <SelectTrigger>
                  ...
                  <CardHeader>
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <CardDescription className="mb-4 line-clamp-2">{job.description}</CardDescription>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Button size="sm" asChild>
                          <Link href={`/jobs/${job.id}/apply`}>Apply with Profile</Link>
                        </Button>
                      </div>
                    </div>
                  </CardContent>
                    ...
                    <div key={index} className="flex items-center justify-between p-4 border rounded-lg">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {application.institution} • Applied {application.applied}
                        </p>
                      </div>
